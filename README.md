...
* Técnicas de abertura de modal e rolagem lateral com **Javascript**.
* Projeto com a estrutura **HTML** que não podia ser alterada, tive que criar as tags, classes pela **DOM**
* Prazo de entrega de 7 dias para o Front-end e Back-end.
